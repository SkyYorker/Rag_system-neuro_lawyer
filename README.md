[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/SkyYorker/Rag_system-neuro_lawyer/blob/main/%D0%9F%D1%80%D0%B0%D0%BA%D1%82%D0%B8%D1%87%D0%B5%D1%81%D0%BA%D0%B0%D1%8F_%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%B0_2.ipynb)
...
- **Полная RAG-система** реализована в `Практическая_работа_2.ipynb`
...
- `docs/` - документация архитектуры и настройки GPU/CPU

> **Для портфолио:** Основная ценность проекта - это **блокнот** с полной реализацией RAG-системы.
...
```
PracticeWork_2/
├── Практическая_работа_2.ipynb  #  ОСНОВНОЙ: Полная RAG-система
...
1. Откройте блокнот в Colab (загрузите файл `Практическая_работа_2.ipynb`)
...
```bash
jupyter notebook "Практическая_работа_2.ipynb"
```
